...
const defaults = { streak: 0, tasks: [], schedule: [], habits: [], goals: [], notes: [], subjects: [], materials: [], colleges: [], focus: { minutes: 25, running: false, startedAt: null, secondsLeft: 1500 }, focusSessions: 0, focusLogs: [], theme: 'light' };
